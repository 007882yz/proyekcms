...
<div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel" data-bs-interval="3000">
	...
	<div class="carousel-inner">
		...
		<div class="carousel-item <?= $index === 0 ? 'active' : ''; ?>">
			<img src="<?= base_url('upload/caraousel/' . $cr['foto']); ?>" class="d-block w-100"
						...
						<div class="catagories-menu">
							<ul id="menu-content2" class="menu-content collapse show">
								...
								<li data-toggle="collapse" data-target="clothing">
									<a href="<?= base_url('asset/front/')?>#">clothing</a>
									<ul class="sub-menu collapse show" id="clothing">
										<?php foreach ($kategori as $kk) { ?>
										<li><a href="<?= base_url('front/brand/index/' . $kk['id_kategori']); ?>"><?= htmlspecialchars($kk['nama_kategori']); ?></a></li>
										<?php } ?>
									</ul>
								</li>
							</ul>
